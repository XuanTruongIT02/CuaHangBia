...
{
    public class GioHang_62131086Controller : Controller
    {
        DBCuaHangBiaOnline_62131086 db = new DBCuaHangBiaOnline_62131086();
        // GET: GioHang
        
        //Lấy giỏ hàng 
        public List<GioHang_62131086> LayGioHang()
        {
            List<GioHang_62131086> lstGioHang = Session["GioHang"] as List<GioHang_62131086>;
            if (lstGioHang == null)
            {
                //Nếu giỏ hàng chưa tồn tại thì mình tiến hành khởi tao list giỏ hàng (sessionGioHang)
                lstGioHang = new List<GioHang_62131086>();
        ...
        {
            Sanpham_62131086 sp = db.Sanphams.SingleOrDefault(n => n.Masp == iMasp);
            if ( sp == null)
            {
            ...
            List<GioHang_62131086> lstGioHang = LayGioHang();
            //Kiểm tra sp này đã tồn tại trong session[giohang] chưa
            GioHang_62131086 sanpham = lstGioHang.Find(n => n.iMasp == iMasp);
            if (sanpham == null)
            {
                sanpham = new GioHang_62131086(iMasp);
        ...
        public ActionResult CapNhatGioHang(int iMaSP, FormCollection f)
        {
            ...
            GioHang_62131086 sanpham = lstGioHang.SingleOrDefault(n => n.iMasp == iMaSP);
        ...
        public ActionResult DatHang(FormCollection donhangForm)
        {
            ...
            //Thêm đơn hàng
            Donhang_62131086 ddh = new Donhang_62131086();
            Nguoidung_62131086 kh = (Nguoidung_62131086)Session["use"];
            List<GioHang_62131086> gh = LayGioHang();
            ...
            foreach (var item in gh)
            {
                Chitietdonhang_62131086 ctDH = new Chitietdonhang_62131086();
                decimal thanhtien =  item.iSoLuong * (decimal) item.dDonGia;
            ...
            db.SaveChanges();
            return RedirectToAction("Index", "Donhang_62131086");
        }
        #endregion
